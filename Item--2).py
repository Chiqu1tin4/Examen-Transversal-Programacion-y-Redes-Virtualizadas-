...
def obtener_distancia(ciudad_origen, ciudad_destino):
    ...
    if response["info"]["statuscode"] == 0:
        ...
        print("No se pudo obtener la distancia. Codigo de estado:", response["info"]["statuscode"])
...
while True:
    ...
    ciudad_destino = input("Ingrese la ciudad de destino (Latinoamerica): ")
    ...
    if distancia is not None:
        ...
        print("La duracion del viaje es de", format(duracion_horas, ".1f"), "horas,", format(duracion_minutos, ".1f"), "minutos y", format(duracion_segundos, ".1f"), "segundos.")
